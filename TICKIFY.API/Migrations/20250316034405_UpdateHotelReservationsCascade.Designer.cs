...
namespace TICKIFY.Infrastracture.Migrations
{
    ...
    [Migration("20250316034405_UpdateHotelReservationsCascade")]
    partial class UpdateHotelReservationsCascade
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TICKIFY.API.Tickify.Domain.Entities.Room", b =>
                {
                    b.Property<int>("RoomId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TICKIFY.Core.Entities.HotelReservation", b =>
                {
                    b.Property<int>("HotelReservationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ReservationDetails", b =>
                {
                    b.HasOne("TICKIFY.Core.Entities.HotelReservation", "HotelReservation")
                        .WithMany("ReservationDetails")
                        .HasForeignKey("HotelReservationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TICKIFY.API.Tickify.Domain.Entities.Room", "Room")
                        .WithMany("ReservationDetails")
