...
{
    /// <inheritdoc />
    public partial class TickFyDB13 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HotelReservations_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HotelReservations_AspNetUsers_UpdatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FlightReservationS_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlightReservationS_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FlightReservationS_Classes_ClassId",
                        column: x => x.ClassId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BedInfos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BedInfos_Rooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelReservationRoomss", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HotelReservationRoomss_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightReservationS_ClassId",
                table: "FlightReservationS",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_FlightReservationS_CreatedById",
                table: "FlightReservationS",
                column: "CreatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightReservationS_UpdatedById",
                table: "FlightReservationS",
                column: "UpdatedById");

            migrationBuilder.CreateIndex(
                name: "IX_HotelReservationRoomss_RoomId",
                table: "HotelReservationRoomss",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_HotelReservations_CreatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelReservations_UpdatedById",
                table: "HotelReservations",
                column: "UpdatedById");
